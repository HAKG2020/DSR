...
def parse_args():
    ...
    parser.add_argument('--transmat_R_dim', type=int, default=64,
                        help='transmat_R_dim.')
    parser.add_argument('--transmat_S_dim', type=int, default=64,
                        help='transmat_S_dim.')
    parser.add_argument('--layer_size', nargs='?', default='[64,64,64]',
                        help='Output sizes of every layer_R')
    parser.add_argument('--layer_size_S', nargs='?', default='[64,64]',
                        help='Output sizes of every layer_S')
